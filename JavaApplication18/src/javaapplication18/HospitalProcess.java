...
System.out.println("Here is the list of doctors");
 String doctor1 = "Ajaz";
 String feild1 = " General Physcian";
 System.out.println("doctor1: "+doctor1);
 System.out.println(feild1);
 String doctor2 = "Rabail";
 String feild2 = " Neurosurgeon ";
 System.out.println("doctor2: "+doctor2);
 System.out.println(feild2);
 String doctor3 = "Fozia";
 String feild3 = " Orthopadic";
 System.out.println("doctor3: "+doctor3);
 System.out.println(feild3);
do
{
...
BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
Patient(int patientID,String patientName,String patientAddress,int age,char patientGender,String patientIllness,float amountForAppointment, String joindate)
{
...
{
char l='n';
Patient p2 = new Patient(patientID, patientName, patientAddress, age, patientGender, patientIllness, amountForAppointment, joindate);
do{
...
for(int i=0; i<hm.arl.size(); i++)
{	 
System.out.println(hm.arl.get(i).patientID + " \t\t "+hm.arl.get(i).patientName+" \t\t "+hm.arl.get(i).patientAddress+" \t\t "+hm.arl.get(i).age+" \t "+hm.arl.get(i).patientGender+" \t "+hm.arl.get(i).patientIllness+" \t\t "+hm.arl.get(i).amountForAppointment+" \t "+hm.arl.get(i).joindate);
}
}				
